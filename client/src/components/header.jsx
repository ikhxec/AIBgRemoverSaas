    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-1 md:order-2">
                ...
                <p className="text-grey-600 mb-8 text-lg leading-relaxed">
                    Transform your photo with our background remover app! Highlight your subject and create a transparent background, you can place it in a variety of new designs and destinations. Try it now and immerse your subject in a completely different enviroment!
                </p>
